...
SECRET_KEY = "django-insecure-z*t6eyreb-aw+gnvq%btcu+agy0tasb3sjck==#3_qq#^5ib*y"
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Path to your templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
